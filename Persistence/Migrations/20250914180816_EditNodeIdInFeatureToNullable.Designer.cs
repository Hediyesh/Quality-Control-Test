...
namespace ControlPersistence.Migrations
{
    ...
    [Migration("20250914180816_EditNodeIdInFeatureToNullable")]
    partial class EditNodeIdInFeatureToNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("FeatureNodeId")
                        .IsUnique()
                        .HasFilter("[FeatureNodeId] IS NOT NULL");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Category", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", "Feature")
                        .WithOne("Category")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Category", "FeatureNodeId")
                        .HasPrincipalKey("ControlDomain.Entities.Feature", "NodeId");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Company", b =>
                {
                    b.HasOne("ControlDomain.Entities.Feature", "Feature")
                        .WithOne("Company")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Company", "FeatureNodeId")
                        .HasPrincipalKey("ControlDomain.Entities.Feature", "NodeId");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Machine", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", "Feature")
                        .WithOne("Machine")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Machine", "FeatureNodeId")
                        .HasPrincipalKey("ControlDomain.Entities.Feature", "NodeId");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", "Feature")
                        .WithOne("Product")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Product", "FeatureNodeId")
                        .HasPrincipalKey("ControlDomain.Entities.Feature", "NodeId");
