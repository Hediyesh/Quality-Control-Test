...
namespace ControlPersistence.Migrations
{
    ...
    [Migration("20250914191857_EditTablesFeaturesParentId")]
    partial class EditTablesFeaturesParentId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControlDomain.Entities.Feature", b =>
                {
                    ...
                    b.HasIndex("NodeId", "Type", "ParentId")
                        .IsUnique()
                        .HasFilter("[NodeId] IS NOT NULL AND [ParentId] IS NOT NULL");
