...
namespace ControlPersistence.Migrations
{
    ...
    [Migration("20250914190633_EditTables")]
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Category", b =>
                {
                    ...
                    b.HasIndex("FeatureId1")
                        .IsUnique()
                        .HasFilter("[FeatureId1] IS NOT NULL");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Category", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", null)
                        .WithOne("Category")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Category", "FeatureId1");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Company", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", null)
                        .WithOne("Company")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Company", "FeatureId1");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Machine", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", null)
                        .WithOne("Machine")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Machine", "FeatureId1");
            ...
            modelBuilder.Entity("ControlService.ControlDomain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("ControlDomain.Entities.Feature", null)
                        .WithOne("Product")
                        .HasForeignKey("ControlService.ControlDomain.Entities.Product", "FeatureId1");
