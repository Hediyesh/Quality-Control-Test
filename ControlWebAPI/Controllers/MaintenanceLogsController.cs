...
using ControlService.ControlApplication.Services.MaintenanceLogs.Commands.DeleteMaintenanceLogs;
using ControlService.ControlApplication.Services.MaintenanceLogs.Commands.EditMaintenanceLogs;
...
using ControlService.ControlApplication.Services.MaintenanceLogs.Queries.GetMaintenanceLog;
using ControlService.ControlApplication.Services.MaintenanceLogs.Queries.GetMLMachinesByCompany;
...
namespace ControlWebAPI.Controllers
{
    ...
    public class MaintenanceLogsController : Controller
    {
        ...
        [HttpGet("UpdateMLMachinesByCompany")]
